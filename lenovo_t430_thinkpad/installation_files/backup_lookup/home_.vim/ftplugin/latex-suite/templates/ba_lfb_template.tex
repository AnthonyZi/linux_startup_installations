...
% anpassen!
\usepackage[pdftex,plainpages=false,pdfpagelabels,colorlinks=true,linkcolor=red, citecolor=blue]{hyperref}
...
%%%%% \lfbbamatitle{Bachelorarbeit}
%%%%% {Entwicklung und Implementierung eines Bildverarbeitungsalgorithmus}     % Deutscher Titel der Arbeit
%%%%% {Development of an Image Processing Algorithm}      % Englischer Titel der Arbeit
%%%%% {Junior Mustermann}                     % Name des Studenten
%%%%% {Senior Mustermann, MSc}          % Betreuer
%%%%% {20XX}                                  % Jahr
%%%%% {Aachen, den 24. Dezember 20XX}         % Ort,Datum (Erklärung) -- Abgabedatum
