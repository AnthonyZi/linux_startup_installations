...
documents_dir=/home/zmann/documents
adb_documents_dir=/storage/A825-16E5/PDFs

time_management_file=${documents_dir}/organisation/time_management_merged.pdf
...
bachelorarbeit_sync_source=/home/zmann/bachelorarbeit/HistoBloodVesselDetection_BA
bachelorarbeit_sync_dest=${adb_documents_dir}/Bachelorarbeit
bachelorarbeit_sync_folders="Planung Recherche Ausarbeitung"
for data in ${bachelorarbeit_sync_folders}
do
    echo "-------- $data --------"
    sync_folder ${bachelorarbeit_sync_source}/${data} ${bachelorarbeit_sync_dest}/${data}
done
